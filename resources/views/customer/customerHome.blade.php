...
<div class="userHome">
    ...
    <div class="col-md-8 ">
            <div class="card">
                <div class="card-header">  <a class="navbar-brand" href="{{ URL::to('/ShowListOfNurseries') }}"> 
                    Nursery List By Provider Name </a></div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="button-container">
                            <a class="btn-solid-reg page-scroll" href="{{ URL::to('/ShowallPlantAd') }}">বুক করুন</a>
